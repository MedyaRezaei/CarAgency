...
namespace CarAgancyLogin.Controllers
{
    public class VehicleController
    {
        ...
        public bool UpdateVehicle(Vehicle vehicle)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                string query = @"UPDATE Vehicles SET 
                                VehicleType = @VehicleType, PlateNumber = @PlateNumber, Model = @Model, Color = @Color, 
                                ManufactureYear = @ManufactureYear, FuelType = @FuelType, InsuranceExpiryDate = @InsuranceExpiryDate, 
        ...
        public bool IsPlateNumberTaken(string plateNumber)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
        ...
        // متد به‌روز شده برای گرفتن پروفایل کاربر بدون IsAvailable
        //public User GetUserProfile(string username)
        //{
        //    User user = null;
        //    using (SqlConnection conn = new SqlConnection(connectionString))
        //    {
        //        string query = @"SELECT Id, Username, Password, Phonenumber, Role, Address, Email, LicenseNumber 
        ...
        //                // بدون IsAvailable چون در پروفایل نیازی نداریم
        //            };
        //        }
        //    }
        //    return user;
